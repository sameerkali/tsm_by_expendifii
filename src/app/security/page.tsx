      ...
      <main id="main-content" className="pt-16" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        <section className="relative overflow-hidden bg-[#F8FAFC] border-b border-slate-200 py-20 sm:py-24">
          ...
          <div className="relative mx-auto max-w-2xl px-4 text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-[#0369A1] mb-4">Security</p>
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-[#0F172A] mb-4">Your data. Locked down.</h1>
        ...
        {/* Practices */}
        <section className="py-20 bg-white" aria-labelledby="security-practices-heading">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <h2 id="security-practices-heading" className="sr-only">Security Practices</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {practices.map((p) => (
                <div key={p.title} className="rounded-2xl border border-slate-200 bg-[#F8FAFC] p-6 hover:shadow-lg hover:shadow-slate-200/60 hover:border-[#0369A1]/30 transition-all duration-200">
                  <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-lg bg-[#0F172A] text-white">
                  ...
                  <h3 className="text-sm font-semibold text-[#0F172A] mb-2">{p.title}</h3>
        ...
        <section className="py-16 bg-[#F8FAFC] border-t border-slate-200">
          <div className="mx-auto max-w-2xl px-4 text-center">
            <h2 className="text-2xl font-bold text-[#0F172A] mb-3">Found a vulnerability?</h2>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#0F172A] px-6 py-3 text-sm font-semibold text-white hover:bg-[#0369A1] transition-colors duration-200 cursor-pointer"
            >
